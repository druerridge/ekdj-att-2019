...
public class CameraHandler : MonoBehaviour
{
    ...
    private static readonly float ZoomSpeedTouch = 10.1f;
    private static readonly float ZoomSpeedMouse = 50f;

    public static readonly float[] BoundsX = new float[] { -100f, 50f };
    public static readonly float[] BoundsZ = new float[] { -180f, -40f };
    public static readonly float[] ZoomBounds = new float[] { 100f, 850f };
    ...
    void ZoomCamera(float offset, float speed)
    {
        ...
        cam.transform.SetPositionAndRotation(cam.transform.position + cam.transform.forward * -5.0f, cam.transform.rotation);
    }
